...
Delta: 22921→22897=-24 | Classification: REAL_MIGRATION
Tests: 20/20 pass | Safety: all pass | Controlled-write: no | Route B: no

Old definitions removed: yes | App explicit calls: yes | Module exports both: yes
Accepted: yes
