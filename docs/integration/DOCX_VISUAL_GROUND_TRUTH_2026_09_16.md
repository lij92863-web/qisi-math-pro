...
> **G6 visual update (2026-09-17):** All 11 rendered pages of `题目+答案.docx` were viewed against the fresh 14-draft run. Q1–14 follow the printed order and wording; Q1, Q10, and Q13 visibly retain unresolved MathType content and are withheld. The printed answer table gives Q1–11 `B B D C B B A B BD BD BC`; Q12–14 answer headings give `√2/2`, `−49/16`, `(-∞,0)∪(0,1]`; each matches its draft. Solution headings likewise follow the printed question numbers. Q8's printed stem itself says right focus `f(x)` while its worked answer says `F`; the draft preserves the source wording. No wrong attachment or silent changed content was observed in G6. G7–G11 remain to be checked at this HEAD.

> **G7 current correction (2026-09-17):** A fresh look at the rendered probability question found a second silent wrong-content defect. `P(A)` and `P(B)` inside inline formulas had been treated as option A/B, cutting the stem after `P\left(` and shifting the real options. Commit `b6f202f` makes the existing shared option splitter ignore labels inside complete math spans. A real DOCX batch rerun now retains the printed Q10 conditions `P(A)=1/6`, `P(B)=1/2`, `P(A|B)=1/3` and all four printed options; its answer remains the printed `ACD`. Q3 also has four options in the current rerun, superseding the historical missing-option row below. The Q1–11 printed key was viewed and agrees with the draft values. The solution pages visible in this 12-page render end during Q15; Q16–19 solution mappings have not been visually proved from these renders. G7 is therefore still partially verified.

> **G8 partial visual update (2026-09-17):** The 12 available rendered pages of `广东深圳高级中学（集团）2026届高三适应性考试数学试卷 (1).docx` were viewed. Question pages 1–8 contain Q1–19 in the draft's order, including the figures for Q5, Q9, Q10, Q11, Q15 and Q17; Q17's unresolved MathType positions are visible and the draft is withheld. The printed Q1–11 key reads `D A B A C D C D AB BCD BC`, matching the draft values. The answer rendering ends during Q8's worked solution, so Q9–19 solution ownership and Q12–14 answer headings cannot be marked visually verified from this render. No silent wrong content was seen in the viewed question stems, but this is not a full G8 verdict.
