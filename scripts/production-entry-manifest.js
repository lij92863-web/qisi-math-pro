...
const classificationEvidence = Object.freeze({
    ...
    'qisi-handout-image-interaction.js': 'H9 frame-throttled direct image move and aspect-ratio resize policy',
    'qisi-handout-qr.js': 'H9 local-only bounded QR encoder for printable question identifiers and links',
    'qisi-handout-table.js': 'H9 structured question-table editing operations without rasterization',
