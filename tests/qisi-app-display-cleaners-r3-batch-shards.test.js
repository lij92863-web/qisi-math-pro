...
describe('bm-a4-r3-batch-executor', () => {
    ...
    it('executor keeps retired wrappers out of the C2-12 shell', () => { const source = fs.readFileSync('app.js', 'utf8'); assert.doesNotMatch(source, /const cleanDisplay(?:Text|Options)ForBatchSave\s*=/); });
